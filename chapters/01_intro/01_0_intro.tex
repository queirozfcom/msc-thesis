...
\ednote{Antes de começar a ter sections é melhor ter um texto introduzindo o capítulo}
...
\ednote{Claro que isso já foi reconhecido há muito tempo pelo pessoal de biblioteconomia e isso é tratado com coisas como classificação facetada ou mesmo pelo padrão de classificação que permite colocar o mesmo item em vários locais da hieraquia. O próprio Google Mail também faz isso, permitindo várias tags}
